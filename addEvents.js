...
console.log(contractAddress, moralisChainId, chainId)
const serverUrl = process.env.NEXT_PUBLIC_SERVER_URL
const appId = process.env.NEXT_PUBLIC_APP_ID
const masterKey = process.env.masterKey
console.log(serverUrl, masterKey, masterKey, appId)
async function main() {
    try {
        ...
        //console.log(itemBoughtOptions, itemBoughtOptions, itemCanceledOptions)
